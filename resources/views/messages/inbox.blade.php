@extends('layouts.vertical', ['title' => 'Inbox', 'subTitle' => 'Your Messages'])
                ...
                @if($messages->count() > 0)
                    <div class="list-group">
                        @foreach($messages as $message)
                            <div class="list-group-item list-group-item-action {{ !$message->read_at ? 'bg-light' : '' }}">
