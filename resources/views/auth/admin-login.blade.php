        ...
        <div class="card auth-card">
            <div class="card-body px-3 py-5">
                ...
                <h2 class="fw-bold text-uppercase text-center fs-18">
                    <i class="ri-shield-admin-line text-danger"></i> Admin Sign In
                </h2>
                <p class="text-muted text-center mt-1 mb-4">Enter your admin credentials to access the admin panel.</p>

                <div class="px-4">
                    <form method="POST" action="{{ route('portal.admin.login.store') }}" class="authentication-form">
                        @csrf
                        @if (sizeof($errors) > 0)
