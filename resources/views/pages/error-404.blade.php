                ...
                <div class="col">
                    <div class="p-4">
                        <div class="mx-auto mb-4 text-center">
                            ...
                            <p class="text-muted mt-1 mb-4">Sorry! The page you're looking for doesn't exist. <br /> It may have been moved or removed from our system.</p>

                            <div class="text-center">
                                <a href="{{ route('second', ['dashboards', 'analytics'])}}" class="btn btn-danger">Back to Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end col -->
