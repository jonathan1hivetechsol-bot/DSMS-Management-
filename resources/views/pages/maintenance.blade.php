            ...
            <div class="row align-items-center g-0">
                ...
                <div class="col-lg-8">
                    <div class="p-4">
                        ...
                        <h2 class="fw-bold text-center lh-base">System Maintenance</h2>
                        <p class="text-muted text-center mt-1 mb-4">Our school management system is undergoing scheduled maintenance. 
                            We'll be back online shortly. Thank you for your patience!</p>

                        <div class="text-center">
                            <a href="mailto:support@digizaro.edu" class="btn btn-danger">Contact Support</a>
                        </div>
                    </div>
                </div> <!-- end col -->
            </div> <!-- end row -->
