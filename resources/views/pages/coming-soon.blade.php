...
<div class="col-lg-8">
    <div class="card auth-card text-center">
        <div class="card-body">
            ...
            <h2 class="fw-bold text-uppercase">Exciting New Feature Coming Soon</h2>
            <p class="lead mt-3 w-75 mx-auto pb-4 fst-italic">We're working on an amazing new feature for the school management system. Stay tuned!</p>
