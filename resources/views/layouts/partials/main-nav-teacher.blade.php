<div class="main-nav">
     ...
     <div class="scrollbar" data-simplebar>
          ...
          <ul class="navbar-nav" id="navbar-nav">
               ...
               <li class="menu-title">Teacher Portal</li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarStudents">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('students.index') }}">View Students</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarStudentLeaves">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('student-leaves.dashboard') }}">Review Leaves</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarMessages">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('messages.index') }}">All Messages</a>
                              </li>
                         </ul>
                    </div>
               </li>
