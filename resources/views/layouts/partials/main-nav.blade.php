          ...
          <ul class="navbar-nav" id="navbar-nav">
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarAnnouncements">
                         <ul class="nav sub-navbar-nav">
                              ...
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('announcements.create') }}">New Announcement</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarTeacherAttendance">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('teacher-attendance.index') }}">All Attendance</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('teacher-attendance.create') }}">Mark Attendance</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ url('teacher-attendance/report') }}">Attendance Report</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarPayroll">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('payroll.index') }}">All Payroll</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('payroll.create') }}">Create Payroll</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ url('payroll/generate') }}">Generate from Attendance</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    <a class="nav-link menu-arrow" href="#sidebarStudentLeaves" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarStudentLeaves">
                         <span class="nav-icon">
                              <i class="ri-calendar-leave-line"></i>
                         </span>
                    ...
                    <div class="collapse" id="sidebarStudentLeaves">
                         <ul class="nav sub-navbar-nav">
                              ...
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('student-leaves.index') }}">All Requests</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('student-leaves.create') }}">New Request</a>
                              </li>
                         </ul>
                    </div>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarWhatsApp">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('whatsapp.dashboard') }}">Dashboard</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('whatsapp.index') }}">All Alerts</a>
                              </li>
                              <li class="sub-nav-item">
                              ...
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="{{ route('whatsapp.recipients') }}">Recipients</a>
                              </li>
                              <li class="sub-nav-item">
                                   <hr class="my-1">
                              </li>
