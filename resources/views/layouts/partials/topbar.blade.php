               ...
               <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="dropdown topbar-item">
                         ...
                         <div class="dropdown-menu dropdown-menu-end">
                              ...
                              <a class="dropdown-item" href="{{ route('second', ['dashboards', 'analytics'])}}">>
                                   <iconify-icon icon="solar:door-broken" class="align-middle me-2 fs-18"></iconify-icon><span class="align-middle">Switch Portal</span>
                              </a>
