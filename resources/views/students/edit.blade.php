@extends('layouts.vertical', ['title' => 'Edit Student', 'subTitle' => 'Update Student Info'])
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Student: {{ $student->user->name }}</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('students.update', $student) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" 
                            ...
                            placeholder="Enter student address">{{ old('address', $student->address) }}</textarea>
