@extends('layouts.vertical', ['title' => 'Edit Teacher', 'subTitle' => 'Update Teacher Info'])
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Teacher: {{ $teacher->user->name }}</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('salary') is-invalid @enderror" 
                                    ...
                                    value="{{ old('salary', $teacher->salary) }}" step="0.01" required>
