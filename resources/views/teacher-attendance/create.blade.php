@extends('layouts.vertical', ['title' => 'Mark Attendance', 'subTitle' => 'Record Teacher Attendance'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light">
                    <h5 class="card-title mb-0">Add Teacher Attendance Record</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('teacher-attendance.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="attendance_date" id="attendance_date" value="{{ old('attendance_date', $today) }}" class="form-control @error('attendance_date') is-invalid @enderror" required>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="remarks" id="remarks" class="form-control @error('remarks') is-invalid @enderror" rows="3" placeholder="Enter any remarks...">{{ old('remarks') }}</textarea>
                                @error('remarks')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
